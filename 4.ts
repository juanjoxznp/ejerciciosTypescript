...
// en un lugar determinado. Hacer un programa en TypeScript que cumpla los siguientes requisitos o características 
...
function lavanya(): void {
  switch (servicio) {
    case "Lavado": {
      ...
      switch (lavado) {
        case "1": {
          ...
          let domigratis: string | null = "1"

          switch (domigratis) {
            case "1": {
              console.log (`El costo de el servicio es de ${cantidadPrendas} y el domicilio es gratis`);
              break;
            }
            case "2": {
              console.log (`El costo de el servicio es de ${cantidadPrendas}, sin utilizar el servicio de domicilio`);
              break;
            }
          }
          break;
    ...
    case "Planchado": {
      ...
      console.log (`El costo de el servicio es de ${cantidadPrendas}`);

      let domi: string | null = "2"

      switch (domi) {
        case "1": {
          console.log (`En total serían ${cantidadPrendas + domicilio} con el domicilio incluido :)`);
          break;
        }
        case "2": {
          console.log (`Es con mucho gusto, vuelva pronto :)`);
          break;
        }
      }
      break;
